********************************************************************************
******* calculate final course grades for calpads crscomp17_18_cln_che.dta *****
********************************************************************************

log using "$projdir/log/fgradept17_18.smcl", replace name(fgradept17_18) //start log file for this do file and overwrite existing log file

/* Before running this do file, install egenmore package from ssc */
ssc install egenmore, replace

use "$clndtadir/crscomp17_18_cln_che.dta", clear // use the cleaned dataset
set more off
...
label data "CALPADS crscomp17_18 cleaned data with calculated final number grades"

compress //compress data to save space

save "$clndtadir/crscomp17_18_cln_fgpt_che", replace // save dataset to clean data directory

log close fgradept17_18 //close current log file
