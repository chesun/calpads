********************************************************************************
******* calculate final course grades for calpads crscomp16_17_cln_che.dta *****
********************************************************************************

log using "$projdir/log/fgradept16_17.smcl", replace name(fgradept16_17) //start log file for this do file and overwrite existing log file

/* Before running this do file, install egenmore package from ssc */

use "$clndtadir/crscomp16_17_cln_che.dta", clear // use the cleaned dataset
set more off
...
label data "CALPADS crscomp16_17 cleaned data with calculated final number grades"

compress //compress data to save space

save "$clndtadir/crscomp16_17_cln_fgpt_che", replace // save dataset to clean data directory

log close fgradept16_17 //close current log file
