********************************************************************************
********* cleaning 17-18 calpads crscomp17_18.dta ******************************
********************************************************************************
...
clear
log using "$projdir/log/clean17_18.smcl", replace name(clean17_18) //start log file and overwrite existing log file for this do file

use "$rawdtadir/crscomp17_18.dta", clear
set more off
...
rename uc_honors honortemp //temp var
...
label data "CALPADS crscomp17_18 cleaned data with calculated final number grades" //label the dataset


compress //compress dataset to save space

save "$clndtadir/crscomp17_18_cln_che", replace // save cleaned dataset to clean data directory

log close clean17_18 //close log file
