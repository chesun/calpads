********************************************************************************
********* cleaning 14-15 calpads crscomp14_15.dta ******************************
********************************************************************************
...
clear
log using "$projdir/log/clean14_15.smcl", replace name(clean14_15) //start log file and overwrite existing log file for this do file

use "$rawdtadir/crscomp14_15.dta", clear
set more off
...
rename Stukey stukey //need to find out what this student key is. its data type is long
label var stukey "Student Key, meaning unknown"

rename CALPADSSnpshtKey snapkey //need to find out what this snapshot key is. data type is integer
label var snapkey "CALPADS snapshot key, meaning unknown"

rename EOY1 eoy1 //need to find out what this is. data type is string
label var eoy1 "end of year 1, meaning unknown"
/* from the web: EOY 1 is the End of Year CALPADS reports that are focused on Course Completion and Career Technical Education (CTE) Reporting
https://www.measureed.com/knowledge/knowledge-base/how-do-i-manage-calpads-eoy-1-data-in-powerschool-step-1-of-1-course-completion/ */


rename Acadamic_Year year
...
rename A_G_Course_Reg_Name agname
...
label data "CALPADS crscomp14_15 cleaned data with calculated final number grades" //label the dataset


compress //compress dataset to save space

save "$clndtadir/crscomp14_15_cln_che", replace // save cleaned dataset to clean data directory


log close clean14_15  //close current log file
