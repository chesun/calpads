********************************************************************************
********* cleaning 13-14 calpads crscomp13_14.dta ******************************
********************************************************************************
...
clear
log using "$projdir/log/clean13_14.smcl", replace name(clean13_14) //start log file and overwrite existing log file for this do file

use "$rawdtadir/crscomp13_14.dta", clear
set more off
...
label data "CALPADS crscomp13_14 cleaned data with calculated final number grades" //label the dataset


compress //compress dataset to save space

save "$clndtadir/crscomp13_14_cln_che", replace // save cleaned dataset to clean data directory


log close clean13_14  //close current log file
