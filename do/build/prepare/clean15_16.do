********************************************************************************
********* cleaning 15-16 calpads crscomp15_16.dta ******************************
********************************************************************************
...
clear
log using "$projdir/log/clean15_16.smcl", replace name(clean15_16) //start log file and overwrite existing log file for this do file

use "$rawdtadir/crscomp15_16.dta", clear
set more off
...
label data "CALPADS crscomp15_16 cleaned data with calculated final number grades" // label the dataset

compress //compress dataset to save space

save "$clndtadir/crscomp15_16_cln_che", replace // save cleaned dataset with final numbwe grades to clean data directory

log close clean15_16 //close log file
